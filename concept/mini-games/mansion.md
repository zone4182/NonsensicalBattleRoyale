...
encouraging players to explore the mansion and use their deductive skills to identify the guests.

Currently for version 1.0, the game includes the following floors and rooms:
1. Ground Floor:
    - Entrance Hall (Gray scale color): A grand hall with a chandelier and a large staircase leading to the upper floors.
    - Library: A room filled with shelves of old books, a fireplace, and a cozy reading nook.
...
- First Floor:
    ...
    - Guest Bedroom 2: A charming bedroom with twin beds, a wardrobe, and a reading chair.
    - Bathroom: A well-appointed bathroom with a bathtub, shower, and vanity.
- Second Floor (Blue scale color):
    - Currently under construction, but will include additional guest rooms and a study area.
    - Not accessible to players in version 1.0.
- Attic (Yellow scale color):
    - Can only be accessed through a staircase on the second floor.
    - Not accessible to players in version 1.0.
- Basement (Red scale color):
    - Can only be accessed through a door in the kitchen, which is currenlty locked and requires a special key to open.
    - Not accessible to players in version 1.0.
